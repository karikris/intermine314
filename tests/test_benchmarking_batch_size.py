...
class TestBatchSizeBenchmarkHelpers:
    ...
    def test_assign_workers_prefers_higher_for_small_chunks(self):
        ...
        assert high_parallel == 12
        assert low_parallel == 4
        assert high_parallel >= low_parallel
