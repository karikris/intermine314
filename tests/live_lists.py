...
UNICODE_NAMES = DATA_DIR.joinpath("unicode-names.txt").read_text(encoding="utf-8").splitlines()
...
class LiveListTest(unittest.TestCase):
    ...
    FRANK = [44, None, False, "Frank Möllers"]
    ...
    EMPLOYEE_FILE = str(DATA_DIR / "test-identifiers.list")
    TYPE = "Employee"
    ...
    def testListTagAdding(self):
        s = self.SERVICE
        t = self.TYPE
        list = s.create_list(self.GUYS_NAMES, t, description="Id string", tags=["test", "tag-adding"])
    ...
    def testUnicode(self):
        s = self.SERVICE
        t = self.TYPE
        list = s.create_list(self.UNICODE_NAMES, t, description="unicode names", tags=["test"])
    ...
    def testListTagRemoval(self):
        ...
        list = s.create_list(self.GUYS_NAMES, t, description="tag removal", tags=tags)
    ...
    def testListTagUpdating(self):
        s = self.SERVICE
        t = self.TYPE
        list = s.create_list(self.GUYS_NAMES, t, description="tag updating", tags=["test"])
        self.assertEqual(set(["test"]), list.tags)
        self.assertEqual(
            set(["test", "a-tag", "b-tag"]), set(map(str, s._list_manager.add_tags(list, ["a-tag", "b-tag"])))
        )
        self.assertEqual(set(["test"]), list.tags)
        list.update_tags()
        self.assertEqual(set(["test", "a-tag", "b-tag"]), set(map(str, list.tags)))
    ...
    def test_ladies_names(self):
        ...
        list = s.create_list(self.LADIES_NAMES, t, description="Id list", tags=["Foo", "Bar", "test"])
    ...
    def test_guys_names(self):
        ...
        list = s.create_list(self.GUYS_NAMES, t, description="Id string", tags=["Foo", "Bar", "test"])
        self.assertEqual(list.unmatched_identifiers, set(["Foo", "Bar", "Baz"]))
        self.assertEqual(list.size, 5)
    ...
    def test_from_file(self):
        ...
        list = s.create_list(self.EMPLOYEE_FILE, t, description="Id file", tags=["Foo", "Bar", "test"])
    ...
    def test_renaming(self):
        ...
        list = s.create_list(q, description="test renaming", tags=["test", "query"])
        old_name = list.name
    ...
    def test_from_other_list(self):
        ...
        q = s.select("Employee").where("department.name", "=", "Sales")
        list = s.create_list(q, description="test_from_other_list", tags=["test", "query"])
    ...
    def test_delete(self):
        ...
        q = s.select("Employee").where("department.name", "=", "Sales")
        list = s.create_list(q, description="test_delete", tags=["test", "query"])
    ...
    def test_to_query(self):
        ...
        list = s.create_list(self.EMPLOYEE_FILE, t, description="test_to_query", tags=["test"])
        expected = [
            LiveListTest.KARIM,
            LiveListTest.DAVID,
            LiveListTest.FRANK,
        ...
        got = [row[:3] + row[4:] for row in list.to_query().rows()]
    ...
    def test_iteration(self):
        ...
        list = s.create_list(self.EMPLOYEE_FILE, t, description="test_iteration", tags=["test"])

        # Test iteration:
        got = set([x.age for x in list])
    ...
    def test_unions(self):
        ...
        expected = [
            ...
            LiveListTest.INA,
            LiveListTest.ALEX,
            LiveListTest.JENNIFER,
            LiveListTest.DELPHINE,
            LiveListTest.BRENDA,
            LiveListTest.KEITH,
            LiveListTest.GARETH,
            LiveListTest.CAROL,
    ...
    def test_subtraction(self):
        ...
        expected = [LiveListTest.VINCENT, LiveListTest.ALEX, LiveListTest.KEITH, LiveListTest.GARETH]
